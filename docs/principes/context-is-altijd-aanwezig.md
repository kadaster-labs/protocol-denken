...
_Contextvrije gegevens (data) bestaan niet - elk gegeven heeft betekenis binnen een specifieke context_
...
_Dit principe vormt de basis voor betrouwbare gegevensuitwisseling tussen organisaties met verschillende contexten via robuuste protocollen._
